...
Ara sijang jangi janger ko pyak epong'''),
  Province(
    ...
    ibuKota: 'Padang',
    photo:
        'https://akcdn.detik.net.id/community/media/visual/2022/06/18/tiga-spot-asyik-untuk-menikmati-dan-mengabadikan-jam-gadang-1_169.jpeg?w=700&q=90',
...
''',
  ...
  Province(
    ...
    ibuKota: 'Semarang',
    photo:
        'https://awsimages.detik.net.id/community/media/visual/2022/06/05/ilustrasi-candi-borobudur_43.jpeg?w=600&q=90',
...
''',
  ...
  Province(
    ...
    ibuKota: 'Jayapura',
    photo:
        'https://kompaspedia.kompas.id/wp-content/uploads/2021/02/550234B3-D89C-4C07-7B6AF2A6B5206338-1536x979.jpg',
    laguDaerah: 'Apuse',
    lirikLaguDaerah: '''
Apuse kokon dao
Yarabe soren doreri
